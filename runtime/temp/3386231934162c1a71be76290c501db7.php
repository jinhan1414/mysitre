...
<div class="container m0 bod top70" id="zt">
    ...
    <div class="row top10 mym">
            ...
            <div class="myleft-n">
                ...
                <ul class="list-group">
                    <li class="list-group-item">
                        ...
                        <i class="fa fa-user-secret"></i>&nbsp;第 <?php echo $user['uid']; ?> 位会员
                    </li>
                    <li class="list-group-item">
                        <span class="badge red"><?php echo $user['coin']; ?></span>
                ...
                <a class="btn btn-info top10" href="jquerySubmit" style="width: 100%">发布资源获得jQ币</a>
        ...
        <div class="col-md-8 myright">
            <div class="myright-n">
                <div class="myNav row">
                    <a href="#" id="myPlugin"><i class="fa fa-codepen"></i> 我发布的插件</a>
                    <a href="#" id="myColletcPlugin"><i class="fa fa-heart"></i> 我收藏的插件</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe src="signIn" width="100%" height="100%" frameborder="0" ></iframe>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="height:550px">
                    <iframe name="myFrame" src="myPhoto" width="100%" height="100%" frameborder="0" ></iframe>
                </div>
